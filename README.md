...
## 🚧 Estado del Proyecto / Roadmap (Next Steps)
...
## 🚀 Uso Local (MVP)
Para ejecutar la ingesta local y probar el modelo de extracción:
1. Clonar el repositorio.
2. Instalar dependencias: `pip install -r requirements.txt`
3. Ejecutar el orquestador principal: `python main_etl.py`
